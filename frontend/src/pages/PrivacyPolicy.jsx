...
<main>
   ...
   <section className="contentContainer contentPages policyContent">
      <div className="container">
         <div class="row">
            <div class="col-md-12">
               <p>Thank you for visiting us online</p>
               <p>This Privacy Policy describes how your personal information is collected, used, and shared when you visit or make a purchase from eCommerce website. We sell spices, food ingredient, vitamins, preservatives etc.</p>
               <div className="mt-5">
               ...
               <h4>SHARING YOUR PERSONAL INFORMATION</h4>
                  ...
                  <p>We also use Google Analytics to help us understand how our customers use the Site--you can read more about how Google uses your Personal Information here: <a href="https://www.google.com/intl/en/policies/privacy/">https://www.google.com/intl/en/policies/privacy/</a>.</p>
               ...
               <div className="mt-5">
                  <h4>CONTACT US</h4>
                  <p>For more information about our privacy practices, if you have questions, or if you would like to make a complaint, please contact us by e-mail at binjalpatel@unitedfoodscorp.com or by mail using the details provided below:</p>
                  <p><strong>110 Tices lane, East Brunswick, NJ, 08816, United States</strong> </p><br />
               </div>
               <h4>Quick Questions? Please <Link to="/contact-us">Email us.</Link></h4>
            </div>
         </div>
      </div>
   </section>
