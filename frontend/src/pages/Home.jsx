   ...
   <section className="collectionItems contentContainer">
      <div className="page-width">
         <div className="container">
            <div className="row">
               <div className="col-12">
                  <h2 className="text-center text-white">Canned Pineapples</h2>
               </div>
            </div>
            <div className="row">
               <div className="col-lg-3 col-md-6 col-sm-6 d-flex">
                  <Link to="#" className="productBox">
                     <div className="productImage img-hover-zoom">
                        <img src="/images/products/canned-pineapples-01.jpg" alt="Crushed Pineapple" className="imgResponsive" />
                     </div>
                     <div className="productInfo">
                        <h5 className="productName">Crushed Pineapple</h5>
                        <div className="productPrice">$79.50</div>
                     </div>
                  </Link>
               </div>
               <div className="col-lg-3 col-md-6 col-sm-6 d-flex">
                  <Link to="#" className="productBox">
                     <div className="productImage img-hover-zoom">
                        <img src="/images/products/canned-pineapples-02.jpg" alt="Mini Pineapple" className="imgResponsive" />
                     </div>
                     <div className="productInfo">
                        <h5 className="productName">Mini Pineapple</h5>
                        <div className="productPrice">$150.76</div>
                     </div>
                  </Link>
               </div>
               <div className="col-lg-3 col-md-6 col-sm-6 d-flex">
                  <Link to="#" className="productBox">
                     <div className="productImage img-hover-zoom">
                        <img src="/images/products/canned-pineapples-03.jpg" alt="Pineapple Tidbits In Natural Juice" className="imgResponsive" />
                     </div>
                     <div className="productInfo">
                        <h5 className="productName">Pineapple Tidbits In Natural Juice</h5>
                        <div className="productPrice">From $20.76</div>
                     </div>
                  </Link>
               </div>
               <div className="col-lg-3 col-md-6 col-sm-6 d-flex">
                  <Link to="#" className="productBox">
                     <div className="productImage img-hover-zoom">
                        <img src="/images/products/canned-pineapples-04.jpg" alt="Sliced Pineapple" className="imgResponsive" />
                     </div>
                     <div className="productInfo">
                        <h5 className="productName">Sliced Pineapple</h5>
                        <div className="productPrice">$62.26</div>
                     </div>
                  </Link>
               </div>
            </div>
            <div className="row text-center">
               <div className="col-12"> <Link to="#" className="custom-btn1 custom-btn2 marginTop16">View ALL Canned Pineapples »</Link> </div>
            </div>
         </div>
      </div>
   </section>
